# Lab 8 — Join Data from Multiple Tables: Mock Data
...
| `Customers` | 60 | [Customers.csv](Customers.csv) | 60 loyalty members — tier, join date, points, birth year (some NULL) and home district. |
...
| `left_t` | 4 | [left_t.csv](left_t.csv) | Practice table for the FULL OUTER JOIN emulation (ids 1-4). |
| `right_t` | 4 | [right_t.csv](right_t.csv) | Practice table for the FULL OUTER JOIN emulation (ids 3-6). |
